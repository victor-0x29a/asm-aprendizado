section .data
    msg db 'Victao', 0xA ; Faco uma referencia (nao eh uma variavel) ao valor 'Victor', concatenando o valor 10 em hexadecimal que se refere a quebra de linha na tabela ascii
